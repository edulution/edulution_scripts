...
alias restartko='sudo service nginx restart;python -m kolibri stop;python -m kolibri start;chmod +x ~/.baseline_testing/scripts/startup_script;~/.baseline_testing/scripts/startup_script'
