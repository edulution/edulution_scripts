...
alias restartko='sudo service nginx restart;~/.scripts/restart_kolibri.sh;chmod +x ~/.baseline_testing/scripts/startup_script;~/.baseline_testing/scripts/startup_script'
