...
alias restartko='workon kolibri;~/.scripts/restart_kolibri.sh;~/.scripts/config/flyway_bl.sh migrate;~/.scripts/config/flyway_bl.sh repair;~/.baseline_testing/scripts/startup_script;sudo systemctl restart nginx.service'
